<div class="companies artax_view">
<h2><?php  __('Firma');?></h2>
	<?php
        //pr($company);
        echo '<table>';
        ...
        echo'</tr>';
        echo '<tr>';
            echo '<th>'.__('Hlavní kontakt', true).'</th>';
            echo '<td>';
                echo 'Jméno: '.$company['CdKontakt']['jmeno'].'<br />';
                echo 'Příjmení: '.$company['CdKontakt']['prijmeni'].'<br />';
                echo 'Email: '.$company['CdKontakt']['email'].'<br />';
                echo 'Telefon: '.$company['CdKontakt']['tel'].'<br />';
                echo 'Pozice: '.$company['CdKontakt']['pozice'].'<br />';
            echo '</td>';
        echo'</tr>';
        echo '<tr>';
        ...
        echo'</tr>';
        echo '<tr>';
            echo '<th>'.__('Career Brožura kontakt', true).'</th>';
            echo '<td>';
                echo 'Jméno: '.$company['CbKontakt']['jmeno'].'<br />';
                echo 'Příjmení: '.$company['CbKontakt']['prijmeni'].'<br />';
                echo 'Email: '.$company['CbKontakt']['email'].'<br />';
                echo 'Telefon: '.$company['CbKontakt']['tel'].'<br />';
                echo 'Pozice: '.$company['CbKontakt']['pozice'].'<br />';
            echo '</td>';
        echo'</tr>';
        echo '<tr>';
            echo '<th>'.__('Logo na web', true).'</th>';
            echo '<td>';
                if(!empty($company['Company']['web_logo']))
                    echo $this->Html->link($company['Company']['web_logo'], $company['Company']['web_logo']);
            echo '</td>';
        echo'</tr>';
        echo '<tr>';
            echo '<th>'.__('Logo na tisk', true).'</th>';
            echo '<td>';
            if(!empty($company['Company']['hi_logo']))
                echo $this->Html->link($company['Company']['hi_logo'], $company['Company']['hi_logo']);
            echo '</td>';
        echo'</tr>';
        echo '</table>';
        ?>
