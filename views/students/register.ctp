...
<div class="students reg form register">
    <fieldset>
        ...
        <div class="message notice">
            <h2>Upozornění</h2>
            <p>Všechna pole v registračním formuláři jsou povinná. Ověření registračního kódu má platnost pouze pro tento formulář,
            poté se musí registrační kód ověřit znovu. Pouhým ověřením registrační kód nepropadá.</p>
        </div>
        <?php
            echo $this->Form->create('Student');
            echo $this->Form->hidden('Smss.generated_key', array('value' => $RegCod));
            ...
            echo '<fieldset><legend>Ubytování v hotelu Krystal</legend>';
            echo '<p>Tým Career Days si pro tebe přichystal možnost <strong>závazně</strong> si zamluvit ubytování v hotelu <a href="http://www.ubytovani-hotel-krystal.cz/" target="_blank">Krystal</a> za 330 Kč se snídaní.'
            .' Pokud máš o toto ubytování zájem, prosím zaškrtni následující políčko.</p>'
            .'<p>Zájem potvrď během prvního dne, nejpozději do 12:00, na infostánku (první patro u schodiště), v případě nepotvrzení bude Tvoje místo nabídnuto ostatním zájemcům.</p>';
            echo $this->Form->checkbox('chce_hotel', array('label' => 'Ubytování v hotelu Krystal'));
            echo 'Chci ubytování v hotelu Krystal';
            echo '</fieldset>';
